-- Kontrollera befintlig user_role enum och uppdatera om nödvändigt
ALTER TYPE user_role ADD VALUE IF NOT EXISTS 'owner';
ALTER TYPE user_role ADD VALUE IF NOT EXISTS 'customer';

-- Lägg till role-kolumn till profiles om den inte finns (använd text istället för enum för nu)
