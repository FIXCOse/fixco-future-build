-- Fix create_job_from_quote function with correct address handling
...
begin
  ...
  select
    ...
    COALESCE(b.payload->>'address', b.payload->>'customer_address', p.address_line) as address,
    COALESCE(b.payload->>'postal_code', p.postal_code) as postal_code,
    COALESCE(b.payload->>'city', p.city) as city,
  ...
  left join public.profiles p on q.customer_id = p.id
