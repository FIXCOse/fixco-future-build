  ...
  return (
    <section className="py-24 bg-gradient-primary-subtle relative">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-15">
        <div 
          className="absolute top-20 left-20 w-16 h-16 bg-primary/30 rotate-12 animate-pulse rounded-sm"
          style={{ animationDuration: '5s' }}
          aria-hidden="true"
        />
        <div 
          className="absolute bottom-20 right-20 w-20 h-20 bg-primary/25 -rotate-6 animate-pulse rounded-sm"
