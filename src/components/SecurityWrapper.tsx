  ...
  return (
    <>
      <Helmet>
        ...
        {/* Improved CSP with Supabase support and Google Fonts */}
        <meta 
          httpEquiv="Content-Security-Policy" 
          content="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://fnzjgohubvaxwpmnvwdq.supabase.co https://www.googletagmanager.com https://www.google-analytics.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; style-src-elem 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https: blob:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://fnzjgohubvaxwpmnvwdq.supabase.co wss://fnzjgohubvaxwpmnvwdq.supabase.co https://www.google-analytics.com; frame-ancestors 'self';" 
        />
      </Helmet>
      {children}
    </>
