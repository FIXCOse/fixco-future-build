                ...
                <Draggable key={`service-${service.slug}`} draggableId={`service-${service.slug}`} index={index}>
                  {(provided, snapshot) => (
                    ...
                    >
                      <div 
                        className={`
                          card-service p-6 text-center h-full transition-all duration-300 animate-fade-in-up
                          ${snapshot.isDragging ? 'shadow-glow border-2 border-primary' : 'hover:shadow-glow hover-scale'}
                          relative
                        `}
                        style={{ animationDelay: `${index * 0.05}s` }}
                      >
                        ...
                        <div
                          ...
                          className="absolute top-2 left-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 p-1 rounded bg-primary/10 hover:bg-primary/20"
                        >
                        ...
                        <div className="mt-3 text-primary text-xs opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:translate-y-0 translate-y-2">
                          {isEditMode ? 'Dra för att flytta' : t('cta.see_all')}
                        </div>
                      </div>
                    </div>
                  )}
