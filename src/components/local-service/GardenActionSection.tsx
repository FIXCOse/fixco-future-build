...
import { Shield, Percent, TreePine } from "lucide-react";
import gardenImage from "@/assets/tradgard-plantering.webp";

interface GardenActionSectionProps {
  area: string;
}
...
export const GardenActionSection = ({ area }: GardenActionSectionProps) => {
  ...
  return (
    ...
    >
      ...
      <img
        src={gardenImage}
        alt={`Fixco trädgårdsmästare planterar i ${area}`}
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
        <div className="container mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
            Lokala trädgårdsmästare i {area}
          </h2>
