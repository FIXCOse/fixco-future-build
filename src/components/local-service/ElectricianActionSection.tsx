...
interface ElectricianActionSectionProps {
  area: string;
}

export const ElectricianActionSection = ({ area }: ElectricianActionSectionProps) => {
  const usps = [
    { icon: Shield, text: "Auktoriserade elektriker" },
    { icon: Percent, text: "ROT-avdrag 30%" },
    { icon: Zap, text: "Elsäkerhet" },
  ];
  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt={`Fixco elektriker utför elinstallation i ${area}`}
