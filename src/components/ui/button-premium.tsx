  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground font-bold hover:bg-primary/90 hover:scale-105",
        premium: "bg-card border border-primary/20 text-foreground hover:bg-primary/5 hover:border-primary/40",
        cta: "bg-primary text-primary-foreground font-bold hover:bg-primary/90 hover:scale-[1.02] transition-all duration-300",
        "cta-primary": "bg-primary text-primary-foreground font-bold hover:bg-primary/90 hover:scale-[1.02] transition-all duration-300",
