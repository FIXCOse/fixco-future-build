                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                    ...
                    {job.admin_set_price && job.admin_set_price > 0 && (
                      <div className="bg-gradient-to-r from-green-100 to-green-100 border-2 border-green-500 rounded-lg px-3 py-2">
                        <div className="flex items-center gap-2">
                          <Gift className="w-5 h-5 text-green-600 animate-pulse flex-shrink-0" />
                          <div>
