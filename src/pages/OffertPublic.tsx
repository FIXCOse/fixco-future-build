...
import { ArrowRight, ArrowLeft, Calculator, MapPin, CheckCircle, Wrench } from 'lucide-react';
...
export default function OffertPublic() {
  ...
  const handleSubmit = () => {
    // TODO: Save to database via edge function
    console.log('Offert data:', wizardData);
    
    toast.success('✅ Offert skickad! Vi återkommer inom 1 timme.', {
      description: 'Tack för din förfrågan. Du kommer få en bekräftelse via email.',
      duration: 5000,
    });
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold gradient-text">Fixco</h1>
                <p className="text-sm text-muted-foreground">Din lokala hantverkare</p>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-2xl mx-auto">
          <div className="card-premium bg-card border border-border rounded-xl shadow-glow">
            {/* Header */}
