  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta name="description" content={isEnglish ? 'Save 30% on labor costs with ROT tax deduction in Sweden. We handle all paperwork and applications for you. Book a free consultation today.' : 'Spara 30% på arbetskostnaden med ROT-avdrag. Vi sköter alla ansökningar och pappersarbete åt dig. Boka gratis konsultation idag. ★ 5/5 betyg.'} />
        <link rel="canonical" href={`https://fixco.se${isEnglish ? '/en/rot-info' : '/rot-info'}`} />
        <meta property="og:title" content={isEnglish ? 'ROT Tax Deduction - Save 30% | Fixco' : 'ROT-avdrag - Spara 30% | Fixco'} />
        <meta property="og:description" content={isEnglish ? 'Save 30% on labor costs with ROT deduction.' : 'Spara 30% på arbetskostnaden med ROT-avdrag.'} />
        <meta property="og:url" content={`https://fixco.se${isEnglish ? '/en/rot-info' : '/rot-info'}`} />
        ...
        <meta name="twitter:title" content={isEnglish ? 'ROT Tax Deduction - Save 30% | Fixco' : 'ROT-avdrag - Spara 30% | Fixco'} />
        <meta name="twitter:description" content={isEnglish ? 'Save 30% on labor costs with ROT deduction.' : 'Spara 30% på arbetskostnaden med ROT-avdrag.'} />
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org",
          "@type": "FAQPage",
          "mainEntity": [
            { "@type": "Question", "name": isEnglish ? "What is ROT deduction?" : "Vad är ROT-avdrag?", "acceptedAnswer": { "@type": "Answer", "text": isEnglish ? "ROT deduction gives you 30% off labor costs for home renovation. Max 50,000 SEK/year." : "ROT-avdrag ger dig 30% rabatt på arbetskostnaden för renovering. Max 50 000 kr/person/år." } },
            { "@type": "Question", "name": isEnglish ? "What qualifies for ROT?" : "Vad berättigar till ROT-avdrag?", "acceptedAnswer": { "@type": "Answer", "text": isEnglish ? "Carpentry, plumbing, electrical, painting, floor laying, garden work, facade and roof work." : "Snickeri, VVS, el, målning, golvläggning, trädgård, fasad- och takarbeten." } },
            { "@type": "Question", "name": isEnglish ? "How do I apply?" : "Hur ansöker jag?", "acceptedAnswer": { "@type": "Answer", "text": isEnglish ? "We handle everything. You pay 70% and we handle the application to Skatteverket." : "Vi sköter allt. Du betalar 70% och vi hanterar ansökan till Skatteverket." } }
          ]
        })}</script>
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org",
          "@type": "HowTo",
          "name": isEnglish ? "How to get ROT deduction with Fixco" : "Så får du ROT-avdrag med Fixco",
          "description": isEnglish ? "Step by step guide to getting ROT tax deduction" : "Steg-för-steg guide för att få ROT-avdrag",
          "totalTime": "PT10M",
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "ROT-avdrag", "item": "https://fixco.se/rot-info" }
          ]
        })}</script>
      </Helmet>
