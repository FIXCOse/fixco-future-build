          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => {
              ...
              return (
                <div 
                  key={service.slug}
                  className="card-premium p-6 group hover:shadow-glow transition-all duration-300 animate-fade-in-up"
                    ...
                    {showROTPrice ? (
                      <>
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-xl font-bold gradient-text">{service.rotPrice}</span>
                        </div>
