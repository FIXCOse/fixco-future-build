  ...
  | 'pages.rut.examples.title' | 'pages.rut.examples.service1' | 'pages.rut.examples.service2' | 'pages.rut.examples.service3'
   ...
   | 'ailab.pdf_created' | 'ailab.email_sent' | 'ailab.lead_saved'
    ...
    | 'ai_widget.upload_file'
     ...
     // ServiceCity UI texts (for city+service detail pages)
     | 'serviceCity.loading' | 'serviceCity.coverageText' | 'serviceCity.aboutService'
     | 'serviceCity.certifications' | 'serviceCity.commonTasks' | 'serviceCity.exploreRange'
     | 'serviceCity.seeAllServices' | 'serviceCity.showAllServices' | 'serviceCity.seePricesDeductions'
     | 'serviceCity.popularServices' | 'serviceCity.priceExamplesTitle' | 'serviceCity.priceExamplesSubtitle'
     | 'serviceCity.job' | 'serviceCity.price' | 'serviceCity.time' | 'serviceCity.priceAfterRot'
     | 'serviceCity.localStatsTitle' | 'serviceCity.completedJobs' | 'serviceCity.averageRating'
     | 'serviceCity.ratingFrom' | 'serviceCity.responseTime' | 'serviceCity.quoteResponse'
     | 'serviceCity.recommendUs' | 'serviceCity.travelFee' | 'serviceCity.travelFeeIn'
     | 'serviceCity.certificationsTitle' | 'serviceCity.memberSince' | 'serviceCity.qualityCertified'
     | 'serviceCity.liabilityInsurance' | 'serviceCity.millionKr' | 'serviceCity.fTax'
     | 'serviceCity.startWithin' | 'serviceCity.certified' | 'serviceCity.allServicesIn'
     | 'serviceCity.specializedServices' | 'serviceCity.available' | 'serviceCity.allPricesInclude'
     | 'serviceCity.availableIn' | 'serviceCity.whyChooseTitle' | 'serviceCity.qualifiedProfessionals'
     | 'serviceCity.qualifiedProfessionalsDesc' | 'serviceCity.fixedPriceQuote' | 'serviceCity.fixedPriceQuoteDesc'
     | 'serviceCity.rotRutHandling' | 'serviceCity.rotRutHandlingDesc' | 'serviceCity.satisfactionGuarantee'
     | 'serviceCity.satisfactionGuaranteeDesc' | 'serviceCity.quickStart' | 'serviceCity.quickStartDesc'
     | 'serviceCity.localTeam' | 'serviceCity.localTeamDesc' | 'serviceCity.howItWorksTitle'
     | 'serviceCity.howItWorks.step1.title' | 'serviceCity.howItWorks.step1.desc'
     | 'serviceCity.howItWorks.step2.title' | 'serviceCity.howItWorks.step2.desc'
     | 'serviceCity.howItWorks.step3.title' | 'serviceCity.howItWorks.step3.desc'
     | 'serviceCity.howItWorks.step4.title' | 'serviceCity.howItWorks.step4.desc'
     | 'serviceCity.qualityAssuranceTitle' | 'serviceCity.preStartCheck' | 'serviceCity.preStartCheckDesc'
     | 'serviceCity.professionalExecution' | 'serviceCity.professionalExecutionDesc'
     | 'serviceCity.postInstallTest' | 'serviceCity.postInstallTestDesc' | 'serviceCity.finalInspection'
     | 'serviceCity.finalInspectionDesc' | 'serviceCity.guaranteeTitle' | 'serviceCity.customerGuarantee'
     | 'serviceCity.customerGuaranteeDesc' | 'serviceCity.yearsWarranty' | 'serviceCity.yearsWarrantyDesc'
     | 'serviceCity.insurance' | 'serviceCity.insuranceDesc' | 'serviceCity.documentation'
     | 'serviceCity.documentationDesc' | 'serviceCity.faqTitle' | 'serviceCity.faqSubtitle'
     | 'serviceCity.didYouKnow' | 'serviceCity.seasonalTips' | 'serviceCity.seasonalTipsWinter'
     | 'serviceCity.commonProblemsTitle' | 'serviceCity.commonProblemsSubtitle' | 'serviceCity.problem'
     | 'serviceCity.ourSolution' | 'serviceCity.readMore' | 'serviceCity.recognizeAnyProblems'
     | 'serviceCity.freeReview' | 'serviceCity.previousProjects' | 'serviceCity.examplesFromCustomers'
     | 'serviceCity.needHelpElse' | 'serviceCity.needHelpElseDesc' | 'serviceCity.rotRutMostServices'
     | 'serviceCity.fastServiceProfessional' | 'serviceCity.insuranceAllProjects' | 'serviceCity.exploreAllServices'
     | 'serviceCity.exploreAllServicesDesc' | 'serviceCity.toAllServices' | 'serviceCity.areasCoveredTitle'
     | 'serviceCity.areasCoveredDesc' | 'serviceCity.noTravelFee' | 'serviceCity.noTravelFeeDesc'
     | 'serviceCity.flatTravelFee' | 'serviceCity.flatTravelFeeDesc' | 'serviceCity.testimonialsTitle'
     | 'serviceCity.testimonialsSubtitle' | 'serviceCity.realReviews' | 'serviceCity.emergencyTitle'
     | 'serviceCity.emergencySubtitle' | 'serviceCity.emergencyDesc' | 'serviceCity.callEmergency'
     | 'serviceCity.emergencyHours' | 'serviceCity.sameDayService' | 'serviceCity.clearFixedPrice'
     | 'serviceCity.customersAlsoBook' | 'serviceCity.relatedServices' | 'serviceCity.finalCtaTitle'
     | 'serviceCity.finalCtaSubtitle' | 'serviceCity.requestFreeQuote'
