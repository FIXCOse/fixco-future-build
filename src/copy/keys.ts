   ...
   | 'ailab.pdf_created' | 'ailab.email_sent' | 'ailab.lead_saved'
    ...
    | 'ai_widget.upload_file'
     ...
     | 'stickyCta.rotDeduction' | 'stickyCta.locations'
       ...
       | 'serviceCity.ui.authorizationsAndCertifications' | 'serviceCity.ui.commonTasksInCity'
       | 'serviceCity.ui.completeRangeCTA' | 'serviceCity.ui.job' | 'serviceCity.ui.priceAfterROT'
       | 'serviceCity.ui.time' | 'serviceCity.ui.fixcoInCityStats' | 'serviceCity.ui.completedJobsIn2024'
       | 'serviceCity.ui.avgRatingFromCustomers' | 'serviceCity.ui.quoteResponseTime'
       | 'serviceCity.ui.customersRecommendUs' | 'serviceCity.ui.travelCostIn'
       | 'serviceCity.ui.certificationsAndMembership' | 'serviceCity.ui.elsäkerhetsverket'
       | 'serviceCity.ui.authorizedInstaller' | 'serviceCity.ui.certifiedVVSInstaller'
       | 'serviceCity.ui.vocationalCertification' | 'serviceCity.ui.professionalEducation'
       | 'serviceCity.ui.industryAssociation' | 'serviceCity.ui.memberSince2020'
       | 'serviceCity.ui.iso9001' | 'serviceCity.ui.qualityCertified'
       | 'serviceCity.ui.liabilityInsurance' | 'serviceCity.ui.tenMillionKr' | 'serviceCity.ui.travelFee'
       | 'serviceCity.ui.whyCustomersChoose' | 'serviceCity.ui.authorizedAndInsured'
       | 'serviceCity.ui.certifiedPlumbers' | 'serviceCity.ui.professionalCraftsmen'
       | 'serviceCity.ui.allElectriciansAuthorized' | 'serviceCity.ui.certifiedProfessionalsWithInsurance'
       | 'serviceCity.ui.fixedPriceQuote' | 'serviceCity.ui.clearQuoteWithFixedPrice'
       | 'serviceCity.ui.rotRutHandling' | 'serviceCity.ui.rotRutHandlingDescription'
       | 'serviceCity.ui.satisfactionGuarantee' | 'serviceCity.ui.satisfactionGuaranteeDescription'
       | 'serviceCity.ui.quickStart' | 'serviceCity.ui.quickStartDescription'
       | 'serviceCity.ui.localTeam' | 'serviceCity.ui.localTeamDescription'
       | 'serviceCity.ui.allOurServices' | 'serviceCity.ui.specializedServicesAvailable'
       | 'serviceCity.ui.allPricesInclude' | 'serviceCity.ui.availableInAll'
       | 'serviceCity.ui.howItWorks' | 'serviceCity.ui.describeTheJob'
       | 'serviceCity.ui.describeJobDescription' | 'serviceCity.ui.approveQuote'
       | 'serviceCity.ui.approveQuoteDescription' | 'serviceCity.ui.weDoTheJob'
       | 'serviceCity.ui.weDoJobDescription' | 'serviceCity.ui.doneAndGuaranteed'
       | 'serviceCity.ui.doneAndGuaranteedDescription' | 'serviceCity.ui.howWeEnsureQuality'
       | 'serviceCity.ui.controlBeforeStart' | 'serviceCity.ui.controlBeforeStartElectric'
       | 'serviceCity.ui.controlBeforeStartVVS' | 'serviceCity.ui.controlBeforeStartGeneral'
       | 'serviceCity.ui.professionalExecution' | 'serviceCity.ui.professionalExecutionElectric'
       | 'serviceCity.ui.professionalExecutionGeneral' | 'serviceCity.ui.testAfterInstallation'
       | 'serviceCity.ui.testAfterInstallationElectric' | 'serviceCity.ui.testAfterInstallationVVS'
       | 'serviceCity.ui.testAfterInstallationGeneral' | 'serviceCity.ui.finalInspection'
       | 'serviceCity.ui.finalInspectionDescription' | 'serviceCity.ui.fullSecurity'
       | 'serviceCity.ui.satisfiedCustomerGuarantee' | 'serviceCity.ui.satisfiedCustomerGuaranteeDescription'
       | 'serviceCity.ui.twoYearWarranty' | 'serviceCity.ui.twoYearWarrantyDescription'
       | 'serviceCity.ui.liabilityInsurance10M' | 'serviceCity.ui.liabilityInsuranceDescription'
       | 'serviceCity.ui.inspectionReportIncluded' | 'serviceCity.ui.documentationIncluded'
       | 'serviceCity.ui.inspectionReportElectric' | 'serviceCity.ui.inspectionReportVVS'
       | 'serviceCity.ui.inspectionReportGeneral' | 'serviceCity.ui.frequentQuestions'
       | 'serviceCity.ui.answersToCommonQuestions' | 'serviceCity.ui.seasonalTipsWinter'
       | 'serviceCity.ui.seasonalTipsGeneral' | 'serviceCity.ui.commonProblemsWeSolve'
       | 'serviceCity.ui.commonProblemsDescription' | 'serviceCity.ui.theProblem'
       | 'serviceCity.ui.ourSolution' | 'serviceCity.ui.readMoreAbout'
       | 'serviceCity.ui.recognizeTheseProblems' | 'serviceCity.ui.freeReviewAndQuote'
       | 'serviceCity.ui.requestFreeQuote' | 'serviceCity.ui.callUs'
       | 'serviceCity.ui.needHelpWithSomethingElse' | 'serviceCity.ui.needHelpDescription'
       | 'serviceCity.ui.rotRutOnMostServices' | 'serviceCity.ui.fastServiceAndProfessionals'
       | 'serviceCity.ui.insuranceAndGuarantee' | 'serviceCity.ui.exploreAllServices'
       | 'serviceCity.ui.seeCompleteRange' | 'serviceCity.ui.toAllServices'
       | 'serviceCity.ui.allDistrictsIn' | 'serviceCity.ui.wePerformJobsInAll'
       | 'serviceCity.ui.noTravelFeeIn' | 'serviceCity.ui.travelFeeAmount'
       | 'serviceCity.ui.noTravelFeeDescription' | 'serviceCity.ui.travelFeeDescription'
       | 'serviceCity.ui.whatCustomersSay' | 'serviceCity.ui.realReviews'
       | 'serviceCity.ui.emergencyElectric' | 'serviceCity.ui.emergencyVVS'
       | 'serviceCity.ui.emergencyGeneral' | 'serviceCity.ui.emergencyElectricDescription'
       | 'serviceCity.ui.emergencyVVSDescription' | 'serviceCity.ui.emergencyGeneralDescription'
       | 'serviceCity.ui.callForEmergency' | 'serviceCity.ui.openingHours'
       | 'serviceCity.ui.sameDayService' | 'serviceCity.ui.authorizedElectricians'
       | 'serviceCity.ui.certifiedPlumbersShort' | 'serviceCity.ui.professionalCraftsmenShort'
       | 'serviceCity.ui.clearFixedPrice' | 'serviceCity.ui.customersAlsoBook'
       | 'serviceCity.ui.relatedServicesDescription' | 'serviceCity.ui.previousProjects'
       | 'serviceCity.ui.completedProjectsExamples'
       | 'serviceCity.ui.certificationsAndAuth'  | 'serviceCity.ui.commonTasksIn'
       | 'serviceCity.ui.cityCoverageDescription' | 'serviceCity.ui.noTravelFee' | 'serviceCity.ui.travelFeeFixed'
       | 'serviceCity.ui.fixcoInNumbers' | 'serviceCity.ui.completedJobsIn' | 'serviceCity.ui.averageRatingFrom'
       | 'serviceCity.ui.responseTimeQuotes' | 'serviceCity.ui.customersRecommend' | 'serviceCity.ui.travelFeeCityShort'
       | 'serviceCity.ui.certificationsAndMembership' | 'serviceCity.ui.electricalSafetyAuthority'
       | 'serviceCity.ui.certifiedPlumberInstaller' | 'serviceCity.ui.professionalCertification'
       | 'serviceCity.ui.authorizedInstaller' | 'serviceCity.ui.professionalEducation'
       | 'serviceCity.ui.industryAssociation' | 'serviceCity.ui.memberSince2020'
       | 'serviceCity.ui.qualityCertified' | 'serviceCity.ui.liabilityInsurance' | 'serviceCity.ui.tenMillionKr'
       | 'serviceCity.ui.travelFeeLowercase' | 'serviceCity.ui.whyCustomersChoose'
       | 'serviceCity.ui.authorizedAndInsured' | 'serviceCity.ui.certifiedPlumbers'
       | 'serviceCity.ui.professionalCraftsmen' | 'serviceCity.ui.electriciansDescription'
       | 'serviceCity.ui.certifiedProfessionalsDescription' | 'serviceCity.ui.fixedPriceQuote'
       | 'serviceCity.ui.fixedPriceDescription' | 'serviceCity.ui.rotRutHandling'
       | 'serviceCity.ui.rotRutDescription' | 'serviceCity.ui.satisfactionGuarantee'
       | 'serviceCity.ui.satisfactionGuaranteeDetail' | 'serviceCity.ui.quickStart'
       | 'serviceCity.ui.quickStartDescription' | 'serviceCity.ui.localTeam'
       | 'serviceCity.ui.localTeamDescription' | 'serviceCity.ui.allOurServicesIn'
       | 'serviceCity.ui.specializedServicesAvailable' | 'serviceCity.ui.allPricesInclude'
       | 'serviceCity.ui.availableInAll' | 'serviceCity.ui.howServiceWorks'
       | 'serviceCity.ui.describeAssignment' | 'serviceCity.ui.fillFormOrCall'
       | 'serviceCity.ui.approveQuote' | 'serviceCity.ui.clearQuoteDetails'
       | 'serviceCity.ui.wePerformJob' | 'serviceCity.ui.startWithinHours'
       | 'serviceCity.ui.doneAndGuaranteed' | 'serviceCity.ui.finalInspectionDetails'
       | 'serviceCity.ui.howWeEnsureQuality' | 'serviceCity.ui.controlBeforeStart'
       | 'serviceCity.ui.electricalPreCheckDescription' | 'serviceCity.ui.plumbingPreCheckDescription'
       | 'serviceCity.ui.generalPreCheckDescription' | 'serviceCity.ui.professionalExecution'
       | 'serviceCity.ui.electricalExecutionDescription' | 'serviceCity.ui.generalExecutionDescription'
       | 'serviceCity.ui.testAfterInstallation' | 'serviceCity.ui.electricalTestDescription'
       | 'serviceCity.ui.plumbingTestDescription' | 'serviceCity.ui.generalTestDescription'
       | 'serviceCity.ui.finalInspectionAndWarranty' | 'serviceCity.ui.finalInspectionDescription'
       | 'serviceCity.ui.fullSecurityWithGuarantee' | 'serviceCity.ui.satisfiedCustomerGuaranteeText'
       | 'serviceCity.ui.twoYearWarrantyText' | 'serviceCity.ui.liabilityInsurance10M'
       | 'serviceCity.ui.liabilityInsurance10MDescription' | 'serviceCity.ui.inspectionReportDescription'
       | 'serviceCity.ui.frequentQuestionsAbout' | 'serviceCity.ui.answersToCommonQuestionsIn'
       | 'serviceCity.ui.goodToKnowAbout' | 'serviceCity.ui.didYouKnow'
       | 'serviceCity.ui.seasonalTips' | 'serviceCity.ui.seasonalTipsFor'
       | 'serviceCity.ui.commonProblems' | 'serviceCity.ui.commonProblemsText'
       | 'serviceCity.ui.problemLabel' | 'serviceCity.ui.solutionLabel'
       | 'serviceCity.ui.readMoreAboutService' | 'serviceCity.ui.recognizeProblems'
       | 'serviceCity.ui.freeAssessmentOffer' | 'serviceCity.ui.previousProjectsCategory'
       | 'serviceCity.ui.completedProjectsFromCustomers' | 'serviceCity.ui.needHelpSomethingElse'
       | 'serviceCity.ui.completeRangeDescription' | 'serviceCity.ui.rotRutMostServices'
       | 'serviceCity.ui.fastServiceProfessionals' | 'serviceCity.ui.insuranceGuaranteeAll'
       | 'serviceCity.ui.exploreAllServicesTitle' | 'serviceCity.ui.seeCompleteRangePrices'
       | 'serviceCity.ui.toAllServicesLink' | 'serviceCity.ui.serviceInAllDistricts'
       | 'serviceCity.ui.coverageDescription' | 'serviceCity.ui.noTravelCostIn'
       | 'serviceCity.ui.primaryOperatingArea' | 'serviceCity.ui.fixedTravelFeeCity'
       | 'serviceCity.ui.whatCustomersSayIn' | 'serviceCity.ui.realReviewsSatisfied'
       | 'serviceCity.ui.emergencyElectrical' | 'serviceCity.ui.emergencyPlumbing'
       | 'serviceCity.ui.emergencyGeneral' | 'serviceCity.ui.emergencyElectricalDescription'
       | 'serviceCity.ui.emergencyPlumbingDescription' | 'serviceCity.ui.emergencyGeneralDescription'
       | 'serviceCity.ui.callForEmergency' | 'serviceCity.ui.businessHours'
       | 'serviceCity.ui.sameDayServiceText' | 'serviceCity.ui.authorizedElectriciansShort'
       | 'serviceCity.ui.certifiedPlumbersVeryShort' | 'serviceCity.ui.professionalCraftsmenVeryShort'
       | 'serviceCity.ui.clearFixedPrice' | 'serviceCity.ui.customersAlsoBook'
       | 'serviceCity.ui.relatedServicesInterest';