export type CopyKey =
  ...
  | 'categories.entertainment_desc'
   ...
   | 'serviceCategories.malare.title' | 'serviceCategories.malare.description'
   ...
   | 'serviceCategories.malning.title' | 'serviceCategories.malning.description'
  ...
  | 'pages.references.description'
  | 'pages.references.newProject'
  | 'pages.references.stats.completed'
  | 'pages.references.stats.avgRating'
  | 'pages.references.stats.savings'
  | 'pages.references.stats.satisfaction'
  | 'pages.references.heading'
  | 'pages.references.gridDescription'
  | 'pages.references.loading'
  | 'pages.references.viewAllImages'
  | 'pages.references.rotSaving'
  | 'pages.references.rutSaving'
  | 'pages.references.duration'
  | 'pages.references.client'
  | 'pages.references.deleteConfirm'
