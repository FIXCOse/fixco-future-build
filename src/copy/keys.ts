export type CopyKey =
  ...
  | 'pages.rut.examples.title' | 'pages.rut.examples.service1' | 'pages.rut.examples.service2' | 'pages.rut.examples.service3'
   ...
   | 'ailab.pdf_created' | 'ailab.email_sent' | 'ailab.lead_saved'
    ...
    // Service+City pages - Elmontör Uppsala
    | 'serviceCity.el.uppsala.h1' | 'serviceCity.el.uppsala.title' | 'serviceCity.el.uppsala.description'
    | 'serviceCity.el.uppsala.howItWorks.0.title' | 'serviceCity.el.uppsala.howItWorks.0.desc'
    | 'serviceCity.el.uppsala.howItWorks.1.title' | 'serviceCity.el.uppsala.howItWorks.1.desc'
    | 'serviceCity.el.uppsala.howItWorks.2.title' | 'serviceCity.el.uppsala.howItWorks.2.desc'
    | 'serviceCity.el.uppsala.howItWorks.3.title' | 'serviceCity.el.uppsala.howItWorks.3.desc'
    | 'serviceCity.el.uppsala.howItWorks.4.title' | 'serviceCity.el.uppsala.howItWorks.4.desc'
    | 'serviceCity.el.uppsala.priceExample.0.job' | 'serviceCity.el.uppsala.priceExample.0.duration'
    | 'serviceCity.el.uppsala.priceExample.1.job' | 'serviceCity.el.uppsala.priceExample.1.duration'
    | 'serviceCity.el.uppsala.priceExample.2.job' | 'serviceCity.el.uppsala.priceExample.2.duration'
    | 'serviceCity.el.uppsala.priceExample.3.job' | 'serviceCity.el.uppsala.priceExample.3.duration'
    | 'serviceCity.el.uppsala.quickFact.0' | 'serviceCity.el.uppsala.quickFact.1' | 'serviceCity.el.uppsala.quickFact.2'
    | 'serviceCity.el.uppsala.quickFact.3' | 'serviceCity.el.uppsala.quickFact.4' | 'serviceCity.el.uppsala.quickFact.5'
    | 'serviceCity.el.uppsala.quickFact.6' | 'serviceCity.el.uppsala.quickFact.7' | 'serviceCity.el.uppsala.quickFact.8'
    | 'serviceCity.el.uppsala.quickFact.9' | 'serviceCity.el.uppsala.quickFact.10' | 'serviceCity.el.uppsala.quickFact.11'
    | 'serviceCity.el.uppsala.didYouKnow.0' | 'serviceCity.el.uppsala.didYouKnow.1' | 'serviceCity.el.uppsala.didYouKnow.2'
    | 'serviceCity.el.uppsala.didYouKnow.3' | 'serviceCity.el.uppsala.didYouKnow.4' | 'serviceCity.el.uppsala.didYouKnow.5'
    | 'serviceCity.el.uppsala.didYouKnow.6'
    | 'serviceCity.el.uppsala.faq.0.q' | 'serviceCity.el.uppsala.faq.0.a'
    | 'serviceCity.el.uppsala.faq.1.q' | 'serviceCity.el.uppsala.faq.1.a'
    | 'serviceCity.el.uppsala.faq.2.q' | 'serviceCity.el.uppsala.faq.2.a'
    | 'serviceCity.el.uppsala.case.0.title' | 'serviceCity.el.uppsala.case.0.desc'
    | 'serviceCity.el.uppsala.case.1.title' | 'serviceCity.el.uppsala.case.1.desc'
    | 'serviceCity.el.uppsala.case.2.title' | 'serviceCity.el.uppsala.case.2.desc'
    
    // Service+City pages - Elmontör Stockholm
    | 'serviceCity.el.stockholm.h1' | 'serviceCity.el.stockholm.title' | 'serviceCity.el.stockholm.description'
    | 'serviceCity.el.stockholm.howItWorks.0.title' | 'serviceCity.el.stockholm.howItWorks.0.desc'
    | 'serviceCity.el.stockholm.howItWorks.1.title' | 'serviceCity.el.stockholm.howItWorks.1.desc'
    | 'serviceCity.el.stockholm.howItWorks.2.title' | 'serviceCity.el.stockholm.howItWorks.2.desc'
    | 'serviceCity.el.stockholm.howItWorks.3.title' | 'serviceCity.el.stockholm.howItWorks.3.desc'
    | 'serviceCity.el.stockholm.howItWorks.4.title' | 'serviceCity.el.stockholm.howItWorks.4.desc'
    | 'serviceCity.el.stockholm.priceExample.0.job' | 'serviceCity.el.stockholm.priceExample.0.duration'
    | 'serviceCity.el.stockholm.priceExample.1.job' | 'serviceCity.el.stockholm.priceExample.1.duration'
    | 'serviceCity.el.stockholm.priceExample.2.job' | 'serviceCity.el.stockholm.priceExample.2.duration'
    | 'serviceCity.el.stockholm.priceExample.3.job' | 'serviceCity.el.stockholm.priceExample.3.duration'
    | 'serviceCity.el.stockholm.quickFact.0' | 'serviceCity.el.stockholm.quickFact.1' | 'serviceCity.el.stockholm.quickFact.2'
    | 'serviceCity.el.stockholm.quickFact.3' | 'serviceCity.el.stockholm.quickFact.4' | 'serviceCity.el.stockholm.quickFact.5'
    | 'serviceCity.el.stockholm.quickFact.6' | 'serviceCity.el.stockholm.quickFact.7' | 'serviceCity.el.stockholm.quickFact.8'
    | 'serviceCity.el.stockholm.quickFact.9' | 'serviceCity.el.stockholm.quickFact.10' | 'serviceCity.el.stockholm.quickFact.11'
    | 'serviceCity.el.stockholm.didYouKnow.0' | 'serviceCity.el.stockholm.didYouKnow.1' | 'serviceCity.el.stockholm.didYouKnow.2'
    | 'serviceCity.el.stockholm.didYouKnow.3' | 'serviceCity.el.stockholm.didYouKnow.4' | 'serviceCity.el.stockholm.didYouKnow.5'
    | 'serviceCity.el.stockholm.didYouKnow.6'
    | 'serviceCity.el.stockholm.faq.0.q' | 'serviceCity.el.stockholm.faq.0.a'
    | 'serviceCity.el.stockholm.faq.1.q' | 'serviceCity.el.stockholm.faq.1.a'
    | 'serviceCity.el.stockholm.case.0.title' | 'serviceCity.el.stockholm.case.0.desc'
    | 'serviceCity.el.stockholm.case.1.title' | 'serviceCity.el.stockholm.case.1.desc'
